...
public class CarController {
	...
	public ResponseEntity<List<Car>> findAllForSale() {
		return new ResponseEntity<>(carService.findAllForSale(), HttpStatus.OK);
	}
	...
	public ResponseEntity<List<Car>> findByUserId(@PathVariable int id) {
		return new ResponseEntity<>(carService.findByUserId(id), HttpStatus.OK);
	}
	...
	public ResponseEntity<Car> update(@PathVariable int id, @PathVariable String status) {
		...
		carService.setNewCarStatus(status, id);
