...
public class TransactionController {
	...
	public ResponseEntity<List<Transaction>> findPurchasesByUserId(@PathVariable int id) {
		return new ResponseEntity<>(transactionService.findPurchasesByUserId(id), HttpStatus.OK);
	}
	...
	public ResponseEntity<List<Transaction>> findSalesByUserId(@PathVariable int id) {
		return new ResponseEntity<>(transactionService.findSalesByUserId(id), HttpStatus.OK);
	}
	...
	public ResponseEntity<Transaction> executePurchase(@RequestBody Transaction tx /* , HttpServletResponse response */) {
		...
		ResponseEntity<Transaction> transaction = new ResponseEntity<>(transactionService.purchase(tx), HttpStatus.OK);
